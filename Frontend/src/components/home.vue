<template>
  <div v-if="!user.authenticated" class="home" style="text-align:center;">
    <div class="log-form">
      <h2>Login to your account</h2>
      <form @submit.prevent="login">
        <input title="email" placeholder="email" type="email" v-model="email" required/>
        <input type="password" title="password" placeholder="password" v-model="password" required/>
